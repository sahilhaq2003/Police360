  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F6F8FC] via-[#EEF2F7] to-[#F6F8FC] text-[#0B214A]">
      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        <div className="flex items-center gap-3">
          {me?.photo ? (
            <img
              src={me.photo}
              alt={me.name}
              className="w-15 h-15 rounded-full object-cover border border-[#E4E9F2]"
            />
          ) : (
        ...
        <p className="text-sm text-[#5A6B85] mb-8">
          Here is your report summary and recent activity overview.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            <div className="mb-3 text-[#00296B]">
            ...
            <div className="text-sm text-[#5A6B85] mt-1">
              View accidents assigned to officers
            </div>
            <div className="mt-4 space-y-2">
              {loading ? (
                ...
                <div className="text-sm text-[#5A6B85]">
                  Click to view all accidents and assign to you.
                </div>
              ) : (
                myAccidents.slice(0, 5).map((a) => (
                  ...
                  >
                    <div className="text-sm font-medium">
                      {a.trackingId} • {a.accidentType?.replaceAll('_', ' ')}
                    </div>
                    <div className="text-[11px] text-[#5A6B85]">
                      {a.status} • {a.locationText}
                    </div>
                    {a.assignedOfficer && (
          ...
          >
            ...
            <div className="text-sm text-[#5A6B85] mt-1">
              Cases assigned to you. View details and add investigation notes.
            </div>
            <div className="mt-4 space-y-2">
              {loading ? (
                <SkeletonRow />
                ...
                myCases.slice(0, 5).map((c) => (
                  ...
                  >
                    <div className="text-sm font-medium">
                      {c.complainant?.name} •{' '}
                      {c.complaintDetails?.typeOfComplaint}
                    </div>
                    <div className="text-[11px] text-[#5A6B85]">
                    ...
                    <div className="mt-2">
                      <button
                        ...
                        className="px-2 py-1 text-xs bg-[#EEF2F7] rounded"
                      >
                        View
                      </button>
                    </div>
